...
export default function SymptomsScreen() {
  ...
  const [severity, setSeverity]       = useState(1); // 0=mild,1=mod,2=severe
        ...
        if (i === 2) {
          setTimeout(() => {
            ...
            const mockResults: Condition[] = [
              { name: 'Malaria',        likelihood: 'High',   percent: 80, color: RED    },
              { name: 'Flu (Influenza)', likelihood: 'Medium', percent: 45, color: ORANGE },
              { name: 'Typhoid',        likelihood: 'Low',    percent: 20, color: TEAL   },
            ];
        ...
        <ScrollView contentContainerStyle={styles.resultsContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.actionCard}>
            ...
            <View style={styles.urgentBanner}>
              <Text style={styles.urgentText}>See a doctor as soon as possible</Text>
              <Text style={styles.urgentDesc}>Your symptoms may need medical attention.</Text>
